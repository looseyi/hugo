---
title: "浅析 SDWebImage 5.5.2 - WebP Plugin"
date: 2020-03-11T23:08:12+08:00
tags: ['Source Code', 'iOS', 'Cache', 'WebImage']
categories: ['iOS', 'Objc']
author: "土土Edmond木"
draft: false
---

本文基于 SDWebImage 5.5.2。重读的原因也是由于发现它的 API 在不断迭代，许多结构已经不同与早期版本，同时也是为了做一个记录。整体分析可以查看上一篇文章：[浅析 SDWebImage 5.5.2](https://looseyi.github.io/post/SourceCode-sdweb/)。
